...
#'
#' @description The dataset is a list of 17 dataframes covering EPL data from seasons
#' 2002-2003 to 2018-2019. The data is retrieved from DataHub.io and Football-data.uk.
#'
#' @usage eplData
...
#' @source \url{http://www.football-data.co.uk/englandm.php}
"eplData"
